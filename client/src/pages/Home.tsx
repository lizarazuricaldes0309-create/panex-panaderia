      ...
      <header className="sticky top-0 z-40 border-b border-[#eadfd2]/80 bg-[#fffaf4]/95 backdrop-blur-md">
        <div className="container flex h-[76px] items-center justify-between gap-5">
          <a href="#inicio" className="flex items-center gap-3" aria-label="Panex inicio">
            ...
            <span className="leading-none"><span className="block font-display text-2xl font-bold tracking-tight text-[#6e3824]">Panex</span><span className="mt-1 block text-[10px] font-bold uppercase tracking-[0.2em] text-[#a88975]">panadería artesanal</span></span>
          </a>
      ...
      <main>
        <section id="inicio" className="container grid items-center gap-10 py-12 md:grid-cols-[.87fr_1.13fr] md:py-20 lg:gap-16 lg:py-24">
          <div className="animate-rise max-w-xl">
            ...
            <h1 className="font-display text-5xl font-semibold leading-[.98] tracking-[-0.045em] text-[#4e2b1f] sm:text-6xl lg:text-[76px]">Pan que se <span className="italic text-[#a64b2a]">siente</span> como hogar.</h1>
